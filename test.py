...
Original file is located at
    https://colab.research.google.com/drive/1RmF85A89WzuViGm5OxAXB_Dp4CR12wGp
"""
...
# load checkpoint
myresnet_check = torch.load('checkpoint.pth')
# load model
myresnet_model = MyResNet34()
# match checkpoint to the model
myresnet_model.load_state_dict(myresnet_check)
# put it into the evaluation mode to remain prediction consistency
myresnet_model.eval()
# put the model into the gpu
myresnet_model.to('cuda:0')

"""The next chunk of code is used to make prediction of the testing set."""
...
y_score = []
for i in range(100):
  result = myresnet_model(torch.tensor(testimages[(100*i):(100*(i+1)),:,:,:],device='cuda:0', dtype=torch.float32))
